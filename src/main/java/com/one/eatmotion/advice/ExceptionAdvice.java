package com.one.eatmotion.advice;

import com.one.eatmotion.advice.exception.*;
...
public class ExceptionAdvice {
  ...
  protected AppError userNotFoundException(
      HttpServletRequest request, NotFoundResourceException e) {
    // 예외 처리의 메시지를 MessageSource 에서 가져오도록 수정
    return AppError.builder()
        .code(Integer.valueOf(getMessage("notFoundResource.code")))
        .message(getMessage("notFoundResource.message"))
        .build();
  }
  ...
  protected AppError userNotUserException(HttpServletRequest request, NotFoundUserException e) {
    return AppError.builder()
        .code(Integer.valueOf(getMessage("notFoundUser.code")))
        .message(getMessage("notFoundUser.message"))
        .build();
  }
  ...
  protected AppError userNotEmailException(HttpServletRequest request, NotFoundEmailException e) {
    return AppError.builder()
        .code(Integer.valueOf(getMessage("notFoundEmail.code")))
        .message(getMessage("notFoundEmail.message"))
        .build();
  }

  @ExceptionHandler(InvalidPasswordException.class)
  @ResponseStatus(HttpStatus.NOT_FOUND)
  protected AppError invalidPasswordException(
      HttpServletRequest request, InvalidPasswordException e) {
    return AppError.builder()
        .code(Integer.valueOf(getMessage("invalidPassword.code")))
        .message(getMessage("invalidPassword.message"))
        .build();
  }
  ...
  protected AppError accessDeniedException(HttpServletRequest request, AccessDeniedException e) {
    return AppError.builder()
        .code(Integer.valueOf(getMessage("accessDenied.code")))
        .message(getMessage("accessDenied.message"))
        .build();
  }
